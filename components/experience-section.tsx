...
export function ExperienceSection() {
  ...
  return (
    <section id="experience" ref={sectionRef} className="py-24 lg:py-32 bg-slate-900/30">
              ...
              >
                <div className={`md:grid md:grid-cols-2 md:gap-8 ${index % 2 === 0 ? "" : "md:direction-rtl"}`}>
                  <div className={`${index % 2 === 0 ? "md:text-right md:pr-12" : "md:col-start-2 md:pl-12"}`}>
                    <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800 hover:border-blue-500/30 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/5">
                      <div
                        className={`flex items-center gap-2 text-blue-400 text-sm mb-2 ${index % 2 === 0 ? "md:justify-end" : ""}`}
                      >
                      ...
                      <div
                        className={`flex items-center gap-2 text-slate-400 mb-4 ${index % 2 === 0 ? "md:justify-end" : ""}`}
                      >
