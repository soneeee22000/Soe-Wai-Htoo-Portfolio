      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {projects.map((project, index) => (
            ...
            >
              <div className="h-full p-6 rounded-xl bg-slate-900/50 border border-slate-800 hover:border-blue-500/30 transition-all duration-300 group hover:shadow-lg hover:shadow-blue-500/5">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-400">{project.organization}</p>
                  </div>
                </div>
