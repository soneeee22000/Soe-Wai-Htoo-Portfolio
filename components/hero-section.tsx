    ...
    <section ref={heroRef} className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="order-2 lg:order-1 text-center lg:text-left">
            ...
            <h1 className="fade-up opacity-0 translate-y-8 transition-all duration-700 delay-200 [&.animate-in]:opacity-100 [&.animate-in]:translate-y-0">
              <span className="block text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-2">Soe Wai Htoo</span>
              <span className="block text-xl sm:text-2xl lg:text-3xl text-blue-400 font-light">
                Aspiring Project Manager
              </span>
            </h1>

            <p className="fade-up opacity-0 translate-y-8 transition-all duration-700 delay-300 [&.animate-in]:opacity-100 [&.animate-in]:translate-y-0 mt-6 text-lg text-slate-400 max-w-xl mx-auto lg:mx-0 leading-relaxed">
            ...
            <div className="fade-up opacity-0 translate-y-8 transition-all duration-700 delay-400 [&.animate-in]:opacity-100 [&.animate-in]:translate-y-0 mt-8 flex flex-wrap items-center justify-center lg:justify-start gap-4">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-8 py-3 border border-slate-700 hover:border-blue-500/50 text-slate-300 hover:text-white rounded-lg transition-all duration-200"
              >
        ...
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 animate-bounce">
          <a href="#about" className="text-slate-500 hover:text-blue-400 transition-colors">
