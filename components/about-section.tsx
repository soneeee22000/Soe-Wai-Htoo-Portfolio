        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="fade-up opacity-0 translate-y-8 transition-all duration-700 delay-100 [&.animate-in]:opacity-100 [&.animate-in]:translate-y-0">
            <p className="text-lg text-slate-700 dark:text-slate-300 leading-relaxed mb-6">
              I am a <span className="text-blue-600 dark:text-blue-400 font-medium">Project Management–oriented professional</span> with a
          ...
          <div className="fade-up opacity-0 translate-y-8 transition-all duration-700 delay-200 [&.animate-in]:opacity-100 [&.animate-in]:translate-y-0 grid gap-6">
            <div className="p-6 rounded-xl bg-white/80 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 hover:border-blue-500/30 transition-colors duration-300">
              <div className="flex items-start gap-4">
                <div className="p-3 rounded-lg bg-blue-500/10 text-blue-600 dark:text-blue-400">
                  <GraduationCap className="w-6 h-6" />
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-1">Education</h3>
                  <p className="text-slate-600 dark:text-slate-400">Master's in International Business Engineering</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 rounded-xl bg-white/80 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 hover:border-blue-500/30 transition-colors duration-300">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-1">Experience</h3>
                  <p className="text-slate-600 dark:text-slate-400">5+ years in technical project coordination</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 rounded-xl bg-white/80 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 hover:border-blue-500/30 transition-colors duration-300">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-1">Objective</h3>
                  <p className="text-slate-600 dark:text-slate-400">Seeking permanent PM role in international environment</p>
                </div>
              </div>
            </div>
          </div>
